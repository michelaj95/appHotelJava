...
<html lang="es">
    ...
    <body>
        ...
        <div class="container-fluid">
           ...
           <%
            String fechaSeleccionada = (String)misession.getAttribute("fechaSeleccionadaCadena");
        %>
                ...
                <div class="x_title">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <br>
                            <h2>Reservas hechas en <%=fechaSeleccionada%> </h2>
                            <br>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card-box table-responsive">
                                <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action" style="width:100%">
                                    ...
                                    <tbody>
                                        <%
                                           List <Reserva> listaReservasFecha = (List) request.getSession().getAttribute("listaReservasFecha");
                                           SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");
                                           for (Reserva res : listaReservasFecha) {
                                        %>
                                        <tr>
                                            <%
